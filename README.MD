...
<uL>
<li>
    UpdateProfile is now available in light/dark mode
</li>
<li>
...
<ul>
    ...
    <li>
        UpdateProfile component styling(text-input)
    </li>
    <li>
...
<li>
    Fixed UpdateProfile bugs
</li>
<li>
    Settings rezises when UpdateProfile is present
</li>
</uL>
...
<li>
    Changed styling for UpdateProfile inside settings for android
</li>
<li>
...
<uL>
    ...
    <li>
        Fixed text-input bugs in UpdateProfile
    </li>
</uL>
...
<ul>
    <li>
        Add conditional css rendering to UpdateProfile component
    </li>
    <li>
        (Optional)Store the post number in AsyncStorage
    </li>
...
# <a id="seventynine">Day 79</a>
# <a id="eighty">Day 80</a>

## Today I have done the following:
<uL>
    <li>
        Added conditional css rendering to UpdateProfile component
    </li>
    <li>
        Stored the post number in AsyncStorage
    </li>
</uL>

# <a id="eightyone">Day 81</a>

## Today I have done the following:
<uL>
    <li>
        Added FAB in MainPage(will later replace add post box)
    </li>
    <li>
        Dark/light mode FAB support
    </li>
    <li>
        Create FloatingActionButton component
    </li>
    <li>
        Remove activity-indicator from UserPost
    </li>
    <li>
        Add activity-indicator to MainPage
    </li>
</uL>
...
<ul>
    ...
    <li>
        Create a dropdown list for the FAB
    </li>
    <li>
        Modify AddPostBox
    </li>
    <li>
        Add a dropdown for the settings
    </li>
</ul>

# <a id="eightytwo">Day 82</a>

## Today I have done the following:
<uL>
    <li>
        Refactor AddPostBox to AddPost
    </li>
    <li>
        Removed AddPost from MainPage
    </li>
    <li>
        Refactor StackNavigator to SwitchNavigator
    </li>
    <li>
        Added AddPost to StackNavigator
    </li>
    <li>
        Successful navigation between FloatingActionButton and AddPost
    </li>
    <li>
        Added navigation props when navigating to AddPost
    </li>
    <li>
        Added choose media from gallery + page styling
    </li>
</uL>
...
# <a id="eightythree">Day 83</a>

## Today I have done the following:
<uL>
    <li>
        Fixed theme not kept between AddPost and MainPage transition
    </li>
    <li>
        Added "x photos added" text
    </li>
    <li>
        Completed AddPost first part
    </li>
</uL>
...
<ul>
    ...
    <li>
        Add the second part of AddPost
    </li>
    <li>
        Add a dropdown for the settings
    </li>
...
# <a id="eightyfour">Day 84</a>

## Today I have done the following:
<uL>
    <li>
        Fixed "x photos added" text bug
    </li>
    <li>
        AddPost component complete
    </li>
    <li>
        Fixed text-input jankyness
    </li>
</uL>
...
## Photos:
<img src="https://github.com/albu-alex/junimea-mobile/blob/main/assets/day84_1.gif" width="50%" height=auto />

# <a id="eightyfive">Day 85</a>

## Today I have done the following:
<uL>
    <li>
        Changed design to show first media content of the post in AddPost
    </li>
    <li>
        Added margin to MainPage activity-indicator
    </li>
    <li>
        Changed search cancel button color to red in Search
    </li>
     <li>
        Alignment fix in Search
    </li>
     <li>
        Refactor
    </li>
...
<uL>
    ...
    <li>
        Fixed button actions bugs
    </li>
     <li>
        Resized light mode juni logo
    </li>
     <li>
        Temporary settings placement
    </li>
</uL>
...
<ul>
    ...
    <li>
        Change Settings component
    </li>
</ul>

# <a id="eightyseven">Day 87</a>

## Today I have done the following:
<uL>
    <li>
        Removed "hey, guest" text from Settings
    </li>
    <li>
        Aligned settings buttons
    </li>
    <li>
        Added custom theme text
    </li>
     <li>
        Styled button text
    </li>
     <li>
        Basic settings styling complete
    </li>
</uL>
...
<uL>
    <li>
        Removed AsyncStorage posts
    </li>
    <li>
        Added UserPost margin-top
    </li>
    <li>
        Upgraded Settings styling
    </li>
    <li>
        Fixed MainPage opacity bugs
    </li>
    <li>
        Fixed Tags alignment + remove unnecessary css code
    </li>
    <li>
        Added scroll to top when pressing settings header button
    </li>
    <li>
        Switched back buttons color in UserProfile
    </li>
    <li>
        Remove unnecessary margin-top in UserPost
    </li>
</uL>
...
<ul>
    ...
    <li>
        Change UpdateProfile component
    </li>
</ul>


## Photos:
<img src="https://github.com/albu-alex/junimea-mobile/blob/main/assets/day88_1.jpg" width="50%" height=auto />
<img src="https://github.com/albu-alex/junimea-mobile/blob/main/assets/day88_2.gif" width="50%" height=auto />

# <a id="eightynine">Day 89</a>

## Today I have done the following:
<uL>
    <li>
        Added icons to Settings buttons
    </li>
    <li>
        Changed SwitchNavigator to StackNavigator
    </li>
    <li>
        Adapt UserProfile to StackNavigator API
    </li>
     <li>
        Refactoring
    </li>
     <li>
        Added OwnStatusBar to UserProfile
    </li>
</uL>
...
<ul>
    ...
    <li>
        Fix UserProfile component
    </li>
</ul>

# <a id="ninety">Day 90</a>

## Today I have done the following:
<uL>
    <li>
        Fixed UserProfile component
    </li>
    <li>
        Removed activity-indicator from UserProfile
    </li>
    <li>
        Transition from Login to MainPage successful
    </li>
</uL>
...
<ul>
    ...
    <li>
        Fix theme not kept bug in transition
    </li>
</ul>

# <a id="ninetyone">Day 91</a>

## Today I have done the following:
<uL>
    <li>
        Access to UpdateProfile through Navigation API
    </li>
    <li>
        Basic UpdateProfile styling
    </li>
    <li>
        Added go back button to UpdateProfile
    </li>
    <li>
        Changed send button color
    </li>
    <li>
        Changed text-input text color and bold
    </li>
    <li>
        Keyboard dismiss on press in UpdateProfile
    </li>
    <li>
        Settings refactor
    </li>
...
<ul>
    <li>
        Add keyboard dismiss wherever needed
    </li>
    <li>
        Exit AddPost after posting
    </li>
    <li>
        Add logos to UpdateProfile
    </li>
    <li>
        Refactor UpdateProfile
    </li>
    <li>
        Add conditional CSS rendering to Settings
    </li>
</ul>

# <a id="ninetytwo">Day 92</a>

## Today I have done the following:
<uL>
    <li>
        Refactored UpdateProfileForm to UpdateProfile
    </li>
    <li>
        Applied conditional CSS rendering to Settings
    </li>
    <li>
        Added logos to UpdateProfile text-inputs
    </li>
    <li>
        Fixed go to login not working in UpdateProfile
    </li>
</uL>
...
<ul>
    <li>
        Add keyboard dismiss to UpdateProfile
    </li>
    <li>
        Add keyboard dismiss to Login
    </li>
    <li>
        Exit AddPost after posting
    </li>
    <li>
        Check where keyboard overlaps the text-input
    </li>
</ul>

# <a id="ninetythree">Day 93</a>

## Today I have done the following:
<uL>
    <li>
        Added keyboard dismiss to UpdateProfile
    </li>
    <li>
        Login refactor
    </li>
    <li>
        Added keyboard dismiss to Login
    </li>
    <li>
        Exit AddPost after post creation
    </li>
</uL>
...
<ul>
    <li>
        Fix keyboard overlaping tags text-input in AddPost
    </li>
</ul>

# <a id="ninetyfour">Day 94</a>

## Today I have done the following:
<uL>
    <li>
        Added KeyboardAvoidingView + refactor
    </li>
    <li>
        Fixed Navigation API bug
    </li>
    <li>
        Fixed crash when no photo added
    </li>
    <li>
        All login/register functionalities fix when Login is initial route
    </li>
    <li>
        Simulated MainPage as initial route due to language constraints
    </li>
     <li>
        Added border-top to 'there are no comments' component
    </li>
</uL>
...
# <a id="ninetyfive">Day 95</a>

## Today I have done the following:
<uL>
    <li>
        First actual photo which is added to post is shown
    </li>
    <li>
        Fixed Navigation API bug
    </li>
...
<ul>
    ...
    <li>
        Add +1 more... in AddPost
    </li>
</ul>

# <a id="ninetysix">Day 96</a>
...
<uL>
    ...
    <li>
        Fixed minor bug + align content
    </li>
    <li>
        Fixed other users' posts shown on different profile + add suggestive text
    </li>
     <li>
        Styled no posts text
    </li>
    <li>
        Fixed no posts shown twice bug
    </li>
    <li>
        Removed keyboard avoiding view
    </li>
</uL>
...
<ul>
    <li>
        Add zoom functionality for Android
    </li>
    <li>
        Fix no zoom in AddPost bug on iOS
    </li>
    <li>
        Exit Settings on press
    </li>
    <li>
        Exit Tags on press
    </li>
...
# <a id="ninetyseven">Day 97</a>

## Today I have done the following:
<uL>
    <li>
        Added close settings button
    </li>
    <li>
        Fixed close settings button no background bug
    </li>
    <li>
        Added tags and settings dismiss on press
    </li>
    <li>
        Zoom photo feature issues due to Vue Native API
    </li>
    <li>
        Found a way to zoom photos on Android
    </li>
</uL>
...
<ul>
    <li>
        Find zoom photo alternative
    </li>
</ul>

# <a id="ninetyeight">Day 98</a>

## Today I have done the following:
<uL>
    <li>
        ZoomPhoto not working in Vue Native
    </li>
    <li>
        Try to add PhotoView to project
    </li>
    <li>
        NPM reinstall dependencies did not fix zoom photo bug
    </li>
    <li>
        Refactor
    </li>
...
# <a id="ninetynine">Day 99</a> & <a id="onehundred">Day 100</a>

## Today I have done the following:
<uL>
    <li>
        Record <a href="https://youtu.be/pCa2a180M6E">juni demo</a>
    </li>
    <li>
        Fix post checking in UserProfile
    </li>
</uL>
...
<ul>
    <li>
        Migrate project to react native
    </li>
</ul>
